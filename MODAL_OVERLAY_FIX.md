...
El modal overlay (`#modal-overlay`) se estaba mostrando en la parte superior del sitio, molestando
la visual al cargar la página.

## 🔍 Causa Raíz

El CSS del modal-overlay tenía `display: flex` por defecto en lugar de `display: none`, lo que hacía
que fuera visible desde el inicio.
...
**Estado**: ✅ RESUELTO - $(date) **Sitio**: http://localhost:5173/
