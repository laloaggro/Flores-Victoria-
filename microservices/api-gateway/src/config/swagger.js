...
const options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description:
        'API Gateway para el sistema de florería Flores Victoria. Proporciona endpoints para autenticación, productos, órdenes y más.',
      contact: {
  ...
  apis: ['./src/routes/*.js', './src/app.js', './docs/swagger/*.yaml'],
};
