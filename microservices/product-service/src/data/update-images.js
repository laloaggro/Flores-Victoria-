...
const imageMapping = {
  ...
  GRD002: [
    '/images/productos/victoria-rosas-001-v3.webp',
    '/images/productos/orquidea-elegante-1.webp',
  ],
  BBY001: [
    '/images/productos/victoria-mixtos-001-v3.webp',
  ...
  THX001: [
    '/images/productos/victoria-margaritas-001-v3.webp',
    '/images/productos/alegria-vibrante-1.webp',
  ],
  THX002: [
    '/images/productos/victoria-gerberas-001-v3.webp',
    '/images/productos/felicidad-colorida-1.webp',
  ],
  SYM001: [
    '/images/productos/victoria-lirios-001-v3.webp',
    '/images/productos/elegancia-femenina-1.webp',
  ],
  SYM002: [
    '/images/productos/victoria-rosas-001-v3.webp',
  ...
  CRP002: [
    '/images/productos/victoria-aniversario-amor-001-v3.webp',
    '/images/productos/elegancia-femenina-1.webp',
  ],
  PLT001: [
  ...
  SEA001: [
    '/images/productos/victoria-tulipanes-001-v3.webp',
    '/images/productos/alegria-vibrante-1.webp',
  ],
  SEA002: [
    '/images/productos/victoria-recuperacion-001-v3.webp',
    '/images/productos/passion-eterna-1.webp',
  ],
  MIN001: [
    '/images/productos/victoria-margaritas-001-v3.webp',
  ...
  VAR001: [
    '/images/productos/victoria-tulipanes-001-v3.webp',
    '/images/productos/victoria-tulipanes-007-v3.webp',
  ],
  VAR002: [
    '/images/productos/victoria-lirios-001-v3.webp',
    '/images/productos/elegancia-femenina-1.webp',
  ...
  VAR004: [
    '/images/productos/victoria-hortensias-001-v3.webp',
    '/images/productos/elegancia-femenina-1.webp',
  ],
  VAR005: [
    '/images/productos/passion-eterna-1.webp',
  ...
  VAR016: [
    '/images/productos/victoria-claveles-001-v3.webp',
    '/images/productos/alegria-vibrante-1.webp',
  ],
};
