...
class ProductImageGenerator {
  constructor(options = {}) {
    ...
    this.outputDir =
      options.outputDir || path.join(__dirname, 'frontend/images/products/generated');
  ...
  generatePrompt(product) {
    ...
    if (productName.includes('ramo') || productName.includes('bouquet'))
      setting = 'elegant wrapping paper with ribbon';
    ...
    const negativePrompt =
      'blurry, low quality, pixelated, grainy, watermark, text, logo, signature, ' +
