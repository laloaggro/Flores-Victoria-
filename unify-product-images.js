...
async function main() {
  ...
  console.log('\n' + '='.repeat(70));
  console.log('\n📊 RESUMEN:\n');
  console.log(`🎨 AI Generadas:        ${aiGenerated} (${Math.round(aiGenerated/products.length*100)}%)`);
  console.log(`🔖 Watermarked:         ${watermarked} (${Math.round(watermarked/products.length*100)}%)`);
