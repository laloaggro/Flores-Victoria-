...
const newProducts = [
  // Nuevos productos para la categoría "Insumos"
  {
    ...
    description:
      'Tierra orgánica especial para macetas, ideal para el crecimiento saludable de tus plantas.',
    price: 8000,
  ...
  },
  {
    ...
    description:
      'Corona fúnebre con gladiolos de varios colores, expresión de integridad y fortaleza.',
    price: 40000,
  ...
  stmt.run(
    ...
    (err) => {
      if (err) {
        ...
        console.log(
          `Producto insertado: ${product.name} - $${product.price} - ${product.category} - ${product.image_url}`
        );
      }
