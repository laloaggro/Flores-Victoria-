...
const orders = [
  {
    ...
    items: [{ productId: 441, productName: 'Hermoso Centro 1', quantity: 2, price: 7171 }],
    total: 14342,
    status: 'Completado',
...
router.post('/create', (req, res) => {
  const { userId, customerName, customerEmail, items, total, shippingAddress, paymentMethod } =
    req.body;
