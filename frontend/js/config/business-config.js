...
export const BUSINESS_CONFIG = {
  ...
  description:
    'Expertos en arreglos florales para todas las ocasiones. Bodas, cumpleaños, eventos corporativos y más.',
  ...
  seo: {
    ...
    defaultDescription:
      'La mejor selección de flores y arreglos florales para todas las ocasiones. Entrega a domicilio en Santiago y alrededores.',
    keywords: [
      'flores',
      'arreglos florales',
      'rosas',
