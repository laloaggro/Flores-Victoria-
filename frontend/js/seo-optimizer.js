...
class SEOOptimizer {
  constructor() {
    this.siteConfig = {
      ...
      description:
        'Florería familiar en Recoleta con más de 20 años de experiencia. Flores naturales y arreglos florales para todas las ocasiones.',
  ...
  generateCatalogSchema() {
    return {
      ...
      description:
        'Descubre nuestra colección completa de hermosos arreglos florales para cada ocasión especial',
  ...
  extractProductData() {
    ...
    const price =
      document.querySelector('[class*="price"]')?.textContent?.replace(/[^0-9]/g, '') || '0';
