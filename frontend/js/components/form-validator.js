 ...
 *   validator.onSubmit((data) => console.log('Valid:', data));
 *
...
const FormValidatorComponent = {
  ...
  createValidator(formElement, options = {}) {
    ...
    const validator = {
      ...
      init() {
        ...
        this.injectStyles();
        console.log(`✅ Form validator initialized for #${this.formId}`);
        return this;
      },
      ...
      destroy() {
        ...
        console.log(`🗑️ Form validator destroyed for #${this.formId}`);
      },
    };
  ...
  destroyAll() {
    ...
    console.log('🗑️ All form validators destroyed');
  },
};
