 ...
 * Versión: 1.0.5 - Forzar actualización de cache
 */

const CACHE_NAME = 'flores-victoria-v1.0.5';
const STATIC_CACHE = 'flores-victoria-static-v1.0.5';
const DYNAMIC_CACHE = 'flores-victoria-dynamic-v1.0.5';
