...
const BUSINESS_CONFIG = window.BUSINESS_CONFIG || {
  ...
  location: { 
    address: { street: '', city: '', state: '', postalCode: '', fullAddress: 'Dirección de la tienda' },
...
class SEOManager {
  ...
  getDefaultData() {
    return {
      ...
      description: this.getMetaContent('description') || 'La mejor selección de flores y arreglos florales',
